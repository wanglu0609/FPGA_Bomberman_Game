...
{
	IO_init();
	volatile unsigned int *KEYS11 = (unsigned int *) 0x10;
	*KEYS11 = 0x22;
	/*while(1)
	{
	...
	USB_HOT_PLUG:
	UsbSoftReset();
	//printf("trying some shit\n");
	//int result = UsbRead(0xC0C8);
	//printf("result was %x\n", result);
	...
	while(1)
	{
		volatile unsigned int *KEYS = (unsigned int *) 0x10;
